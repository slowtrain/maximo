...
import com.cafelivro.mam.asset.AssetActivity;
...
//        });
    ...
    public void addView(Integer rootId , Integer childLayout){
        LayoutInflater inflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ViewGroup childlayout = (ViewGroup) inflater.inflate(childLayout,null);
        ViewGroup root = (ViewGroup)findViewById(rootId);
